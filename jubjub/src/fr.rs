...
impl Field for Fr {
    ...
    fn sqrt_ratio(num: &Self, div: &Self) -> (Choice, Self) {
        // Using the method from Appendix D of "Square Root Computation over Even Extension Fields"
        // by Gora Adj and Francisco Rodríguez-Henríquez
        ...
        if bool::from(div_is_zero | num_is_zero) {
            return (num_is_zero, Self::ZERO);
        }

        // Try to compute sqrt(num/div) = sqrt(num * div^{-1})
        let inv = div.invert().unwrap();
        let ratio = num * &inv;
        let sqrt = ratio.sqrt();

        // Return (was_square, sqrt_if_square)
        (sqrt.is_some(), sqrt.unwrap_or(Self::ZERO))
    }
}
...
impl PrimeField for Fr {
    ...
    const TWO_INV: Self = Fr([
        0xcc96_6e04_c481_7635,
        0x2191_a9d6_c6f1_c6c5,
        0x8bdf_9b9f_205c_16c2,
        0x0c0b_7c6d_6947_2e4f,
    ]);
    const MULTIPLICATIVE_GENERATOR: Self = GENERATOR;
    const S: u32 = S;
    const ROOT_OF_UNITY: Self = ROOT_OF_UNITY;
    const ROOT_OF_UNITY_INV: Self = Fr([
        0x4c03_7c5e_e225_0aa7,
        0x1c1c_e20e_8906_7d0a,
        0xccf2_13bb_8c7f_4c36,
        0x07b8_15e8_9e1a_c15c,
    ]);
    const DELTA: Self = Fr([
        0x7bcf_92d8_2f2f_f66e,
        0x8c5b_85cb_f098_1e02,
        0x7089_552b_319d_465b,
        0x0c3c_c0c4_07cc_935e,
    ]);
